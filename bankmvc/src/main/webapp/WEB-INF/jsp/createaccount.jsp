...
<div align="center">
		...
		<div id="login-box">
			...
			<form:form action="/finishedAccountCreation" method="post" modelAttribute="account">
				...
				<form:input type="text" class="form-control form-rounded" path="customerId" name="customerId" value="${customerId}" readonly="true" />

				<label style="text-align: left;">Enter Account No:</label><span class="required" style="color: red;"> *</span><br>
				<input type="number" class="form-control form-rounded" path="accountId" name="accountId" placeholder="AccountId" autocomplete="off" required="required"/>

				Enter Amount:<span class="required" style="color: red;"> *</span><br>
				<input type="number" class="form-control form-rounded" path="currentBalance" name="currentBalance" placeholder="Amount" autocomplete="off" required="required"/>
				...
				</form:select>Enter Owner Name:<span class="required" style="color: red;"> *</span><br>
				<form:input type="text" class="form-control form-rounded" path="ownerName" name="ownerName" value="${ownerName}" readonly="true" />
