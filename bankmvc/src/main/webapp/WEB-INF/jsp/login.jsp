	...
	<div class="container">
		<div class="card login-card"
			...
			<div class="row no-gutters">
				<div class="col-md-6">
					<div class="card-body">
						<div class="brand-wrapper" align="center">
							<h1 class="header " style="color: aliceblue;">ABI Bank</h1>
						</div>
				...
				<div class="col-md-6">
					<img src="/Images/bank1.jpeg"
						style="width: 680; height: 550; padding-top: 80; padding-right: 130;padding-bottom: 40;"
