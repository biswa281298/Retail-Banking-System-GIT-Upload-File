...
public class MvcController  {
	...
	public ModelAndView createAccount(HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		try {
			...
			model.addAttribute("ownerName", customerFeign.getCustomerDetails(token, custid).getUsername());
	...
	public ModelAndView createAccountAndAccount(@ModelAttribute("customer") CustomerEntity customer, Model model,
		...
		try {
			...
			model.addAttribute("ownerName", customer.getUsername());
			model.addAttribute("account", new Account());
			return new ModelAndView("createaccount");
		} catch (Exception ex) {
	...
	public ModelAndView createAccount(@ModelAttribute("account") Account account, Model model) throws ParseException {
		model.addAttribute("role", "EMPLOYEE");
