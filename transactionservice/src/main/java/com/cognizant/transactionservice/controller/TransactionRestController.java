...
public class TransactionRestController {
	...
	public ResponseEntity<?> makeTransfer(@RequestHeader("Authorization") String token,
	...
	public ResponseEntity<?> makeWithdraw(@RequestHeader("Authorization") String token,
			@Valid @RequestBody AccountInput accountInput){
		if(transactionService.makeWithdraw(token, accountInput))
			return new ResponseEntity<>(true, HttpStatus.OK);
		else
			return new ResponseEntity<>(false, HttpStatus.NOT_ACCEPTABLE);
	}
	...
	public ResponseEntity<?> makeServiceCharges(@RequestHeader("Authorization") String token,
			@Valid @RequestBody AccountInput accountInput) {
